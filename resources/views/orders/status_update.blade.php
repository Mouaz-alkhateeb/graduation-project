            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('status_update', ['id' => $orders->id]) }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                               <label for="inputName" class="control-label">ادخل قيمة المبلغ المراد تحويله</label>
                               <input type="number" class="form-control" id="Amount_current" name="Amount_current" required>
                           </div>

                           <div class="col">
                               <label for="inputName" class="control-label"> رقم البطاقة الإئتمانية / الحساب البنكي </label>
                               <input type="text" class="form-control" id="pyment_card" name="pyment_card" required>
                           </div>
                       </div>
                        <div class="row">
                            <div class="col">
