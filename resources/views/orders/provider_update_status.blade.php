...
<div class="breadcrumb-header justify-content-between pt-5 mt-5 pr-5 mr-5">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">تغيير حالة الطلب</h4>
        </div>
    </div>
</div>
<div class="row mr-5 ml-5 pr-4 pl-4">
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('provider_status_update', ['id' => $orders->id]) }}" method="post"
                    autocomplete="off">
                    {{ csrf_field() }}
                    {{-- 1 --}}
                    <div class="row">
                        <div class="col text-right">
                            ...
                            <input type="text" class="form-control" id="inputName" name="order_number"
                                title="يرجي ادخال رقم الطلب" value="{{ $orders->order_number }}" required readonly>
                        </div>
                    ...
                    <div class="row">
                        <div class="col text-right">
                            ...
                            <input class="form-control" id="PaymentStatus" name="PaymentStatus"
                                value="{{ $orders->PaymentStatus }}" readonly>
                        </div>
                        ...
                        <div class="col text-right">
                            ...
                            <input class="form-control fc-datepicker" name="Payment_Date" placeholder="الطلب غير مدغوع بعد "
                                type="text" value="{{ $orders->Payment_Date }}" readonly>
                        </div>
