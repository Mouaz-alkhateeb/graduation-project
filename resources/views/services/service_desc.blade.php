...
<div class="container">
    <div class="row pt-5 mt-5">
        <div class="col-md-4 pt-2">
            <a class="btn btn-primary font-weight-bold" href="{{url('user_order/create')}}/{{ $service->id }}" role="button">اشتري الخدمة <span class=" bi bi-cart3">
                </span></a>
        </div>
    ...
    <div class="row pt-3">
        <div class="col-md-5 px-3">
            <div class="card" dir="rtl">
                <div class=" card-block px-6">
                    <h3 class="card-title text-center">بطاقة الخدمة</h3>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <h6 class="mb-2 font-weight-bold">مقدم الخدمة</h6>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-3">
            ...
            {{-- <div class="pt-5"> --}}     
                      <button type="button" class=" col-sm-9 btn btn-primary " data-toggle="modal" data-target="#exampleModal">تقييم الخدمة</button>
                      <br>
                      <br>
        ...
        <div class="col-md-7">
            ...
            <a href="{{url('add-review/'.$service->id.'/userreview')}}" class=" col-sm-9 btn btn-primary">اكتب رأيك عن الخدمة</a> 
        </div>
